...
const drawCircle = () => {
    ...
    const circle = new Circle(x, y, width / 2, color)
...
const drawLine = () => {
    ...
    const line = new Line(x, y, x2, y2, color)
...
const drawRectangle = () => {
    ...
    const x2 = document.querySelector('div#third input').value
    const y2 = document.querySelector('div#fourth input').value
    const rectangle = new Rectangle(x, y, x2, y2, color)
...
const drawSquare = () => {
    ...
    const color = color_input.value
    const x2 = document.querySelector('div#third input').value
    const square = new Rectangle(x, y, x2, x2, color)
